...
with col2:
    ...
    st.markdown("\n".join([f"- {p}" for p in reservas]) if reservas else "Ninguna")

# --------------------------
# 5. VISUALIZACIÓN DE LA CANCHA
# --------------------------
with col1:
    ...
    # Vertical: Delanteros arriba, arquero abajo
    ...
    # Lista de suplentes (a la derecha visualmente)
